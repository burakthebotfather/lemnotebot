...
# Добавляем вывод текущего времени Минска
now_minsk = datetime.now()
date_str = now_minsk.strftime("%d.%m.%Y %H:%M")
...
# Daily report @ 22:05 по Минску
scheduler.add_job(
    daily_report,
    CronTrigger(hour=22, minute=5, timezone="Europe/Minsk")
)
